...
execute positioned ~ ~1.62 ~ positioned ^ ^ ^1.6 run loot spawn ~ ~ ~ loot ghostcraft:item/arrows/arrows
...
advancement revoke @s only ghostcraft:kit/support/crate/consumed_arrow
