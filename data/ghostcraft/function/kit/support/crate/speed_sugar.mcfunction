...
execute positioned ~ ~1.62 ~ positioned ^ ^ ^1.6 run loot spawn ~ ~ ~ loot ghostcraft:item/speed_sugar/speed_sugar
...
tag @e[tag=!ghostcraft.kit.support.crate.not_it,type=item] add ghostcraft.game.ghosthunt.item_ownership.compliance.kit.has_speed_sugar
...
advancement revoke @s only ghostcraft:kit/support/crate/consumed_speed_sugar
