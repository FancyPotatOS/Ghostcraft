...
# Armor items
item replace entity @s armor.chest with minecraft:netherite_chestplate[unbreakable={},tooltip_display={"hidden_components":["enchantments", "attribute_modifiers"]},enchantment_glint_override=false,enchantments={"binding_curse":1,"vanishing_curse":1},attribute_modifiers=[{type:"minecraft:armor",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:armor_toughness",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:knockback_resistance",amount:-1,id:"ghostcraft.kit.ghost.feet",operation:add_value}]]
item replace entity @s armor.legs with minecraft:netherite_leggings[unbreakable={},tooltip_display={"hidden_components":["enchantments", "attribute_modifiers"]},enchantment_glint_override=false,enchantments={"binding_curse":1,"vanishing_curse":1},attribute_modifiers=[{type:"minecraft:armor",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:armor_toughness",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:knockback_resistance",amount:-1,id:"ghostcraft.kit.ghost.feet",operation:add_value}]]
item replace entity @s armor.feet with minecraft:netherite_boots[unbreakable={},tooltip_display={"hidden_components":["enchantments", "attribute_modifiers"]},enchantment_glint_override=false,enchantments={"binding_curse":1,"vanishing_curse":1,"ghostcraft:ability/pounce/pounce":1},attribute_modifiers=[{type:"minecraft:armor",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:armor_toughness",amount:-10,id:"ghostcraft.kit.ghost.feet",operation:add_value},{type:"minecraft:knockback_resistance",amount:-1,id:"ghostcraft.kit.ghost.feet",operation:add_value}]]
