...
scoreboard players set kit.ghost.flashbang.timer ghostcraft.config 60
scoreboard players set kit.ghost.flashbang.cycle ghostcraft.config 10

scoreboard players set kit.ghost.poison_grenade.count ghostcraft.config 1
scoreboard players set kit.ghost.poison_grenade.timer ghostcraft.config 60
scoreboard players set kit.ghost.poison_grenade.cycle ghostcraft.config 10
