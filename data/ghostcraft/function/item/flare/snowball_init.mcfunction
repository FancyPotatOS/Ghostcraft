...
summon item ~ ~ ~ {Item:{id:"minecraft:snowball",count:1b},PickupDelay:10000,Tags:["ghostcraft.new", "ghostcraft.item.flare", "ghostcraft.item.ride_trigger", "ghostcraft.item.uuid"]}
