...
execute unless entity @s[tag=ghostcraft.item.grappling_hook.aerial] unless entity @s[tag=ghostcraft.item.grappling_hook.clicked] as @p[tag=ghostcraft.item.grappling_hook.owner] at @s run playsound minecraft:entity.fishing_bobber.retrieve master @s ~ ~ ~ 100000000000 1.9 1
execute unless entity @s[tag=ghostcraft.item.grappling_hook.aerial] unless entity @s[tag=ghostcraft.item.grappling_hook.clicked] as @p[tag=ghostcraft.item.grappling_hook.owner] at @s run playsound minecraft:entity.fishing_bobber.retrieve master @s ~ ~ ~ 100000000000 0.1 1
