...
execute unless entity @s[tag=ghostcraft.item.grappling_hook.aerial] unless entity @s[tag=ghostcraft.item.grappling_hook.clicked] as @p[tag=ghostcraft.item.grappling_hook.owner] at @s run playsound minecraft:entity.fishing_bobber.retrieve master @s ~ ~ ~ 0.3 1.9 0.3
execute unless entity @s[tag=ghostcraft.item.grappling_hook.aerial] unless entity @s[tag=ghostcraft.item.grappling_hook.clicked] as @p[tag=ghostcraft.item.grappling_hook.owner] at @s run playsound minecraft:entity.fishing_bobber.retrieve master @s ~ ~ ~ 0.3 0.1 0.3
