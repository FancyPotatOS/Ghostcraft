...
data modify entity @s Item.components."minecraft:custom_data".ghostcraft.type set value "flashbang"
data modify entity @s Item.components."minecraft:custom_model_data" set value 1804024
