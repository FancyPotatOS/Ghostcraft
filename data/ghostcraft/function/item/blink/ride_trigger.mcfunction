...
execute at @s run playsound minecraft:entity.enderman.teleport hostile @a ~ ~ ~ 1 0.5 0.5
particle minecraft:dust{color:[0.831,0.274,0.925],scale:1} ~ ~ ~ 0 1 0 0 30 force
