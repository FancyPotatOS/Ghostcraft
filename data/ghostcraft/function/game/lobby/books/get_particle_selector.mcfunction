...
#   
#   Purpose: To give the player a book to choose their ghost particles
#
#   Input: None
#


item replace entity @s hotbar.2 with written_book[written_book_content={author:"FancyPotatOS",title:"Ghost Particle Selector",pages:\
[\
    [\
        {\
            "text":"      = Particles =\n\n"\
