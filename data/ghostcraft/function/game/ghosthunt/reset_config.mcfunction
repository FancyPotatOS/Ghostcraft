#
#   Ghosthunt Config Reset
#   
#   Purpose: To reset any config items
#
#   Input: None
#


scoreboard players set game.ghosthunt.ghosts ghostcraft.config 1
scoreboard players set game.ghosthunt.min_survivors ghostcraft.config 1
scoreboard players set game.ghosthunt.game_time ghostcraft.config 6000
