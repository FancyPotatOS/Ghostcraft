...
scoreboard players set ghosts_left ghostcraft.temp -1
execute as @e[type=#ghostcraft:player,tag=ghostcraft.game.ghosthunt.role.ghost] run scoreboard players add ghosts_left ghostcraft.temp 1
...
execute if score ghosts_left ghostcraft.temp matches 1 run tellraw @a[tag=ghostcraft.game.ghosthunt.role.ghost] {"color":"red","bold":true,"text":"You are the last ghost..."}
